...
var settingsUIKeys = []string{
	...
	"stackchan_speech_motion_enabled", "stackchan_motion_speed", "stackchan_motion_step_delay_ms", "stackchan_loud_startle_enabled", "stackchan_loud_startle_cooldown_seconds", "stackchan_expression_colors",
